...
public class test_interface extends Application {
	...
	public void start (Stage primaryStage) throws Exception{
		...
		topMenu.setStyle("-fx-background-color: #6495ED;"); //Здесь раскрашиваю поля, делаю отступы 
		...
		button_run.setOnAction(e -> System.out.println("Run")); //Тут я пробовал привязать действия к кнопкам
